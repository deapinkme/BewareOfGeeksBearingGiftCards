...
void setupgc() {
	examplegc.num_bytes = -1; // !!!crash 1: changed num_bytes from 116 to -1!!!
	...
	examplegcrd.type_of_record = 2; // cov1: changed from 1 to 2 (would also produce different cov as 3)
